...
//       fragment.appendChild(renderPin(window.similarAdsArray[i]));
//     }
...
// var pinMain = window.map.map.querySelector('.map__pin--main');
//
...
//   window.map.map.appendChild(randomItemCardInArray);
//   window.map.map.appendChild(insertPinsInMap(similarAdsArray));
//
// });
//
...
//     var randomItemCardInArray = window.renderCard(similarAdsArray[window.getRandomInt(0, similarAdsArray.length - 1)]);
//     window.map.map.appendChild(randomItemCardInArray);
//     window.map.map.appendChild(window.insertPinsInMap(similarAdsArray));
//   }
// });
...
// inputAddress.value = getAddressValue(window.pinMain);
//
//
...
//   if (capacitySelect.disabled = true) {
//     evt.preventDefault();
